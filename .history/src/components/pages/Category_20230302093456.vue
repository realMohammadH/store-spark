      ...
      <grid>
        <flex v-for="card in cards">
          <image-wrapper
            ...
            <!--
            :floatImg="$renderImage(card.imageCard.floatImage.path)"
            --
          >
            :floatImgWidth="card.imageCard.floatImage.width"
            :floatImgHeight="card.imageCard.floatImage.height" ></image-wrapper
          >
          <wrapper>
